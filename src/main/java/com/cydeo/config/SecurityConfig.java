...
public class SecurityConfig extends KeycloakWebSecurityConfigurerAdapter {  // coming from the dependency
    @Override  // need to override this method when extending above
